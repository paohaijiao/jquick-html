 ...
 */
package com.github.paohaijiao.node.h2.impl;

import com.github.paohaijiao.common.Node;
import com.github.paohaijiao.node.h2.H2;
...
public class H2Impl implements H2 {
    ...
    /**
     * 设置 CSS 类名（如 "section-title"、"text-secondary"）
     * 用于控制二级标题的样式（通常比 h1 小一号）
     */
    ...
    /**
     * 设置唯一标识（用于章节锚点跳转，如 <a href="#chapter-2">跳转到第二章</a>）
     */
