 ...
 */
package com.github.paohaijiao.node.h4.impl;
...
public class H4Impl implements Heading {
    ...
    /**
     * 设置 CSS 类名（如 "subsubsection-title"、"text-quaternary"）
     * 用于控制四级标题的样式（通常比 h3 小一号）
     */
    ...
    /**
     * 设置唯一标识（用于更细粒度的锚点跳转，如 <a href="#item-2-1-1">跳转到 2.1.1 条目</a>）
     */
